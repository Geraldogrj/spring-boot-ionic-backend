...
public class Produto implements Serializable {
	...
	@JoinTable(name = "PRODUTO_CATEGORIA", //JoinTable para criar uma tabela intermediária no BD com o nome que eu der;
		...
		inverseJoinColumns = @JoinColumn (name = "categoria_id") //Por último, a chave estrangeira que a minha associação irá referenciar
		)
	...
	/**
	 * Para que o produto conheça os itens de seu pedido conforme diagrama;
	 * @return
	 */
